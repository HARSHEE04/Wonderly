...
class _LearnChallengeScreenState extends State<LearnChallengeScreen> {
  ...
  Future<void> _loadChallenge() async {
    ...
    if (_loading || result == null) {
      if (result == null) setState(() => _error = 'Could not load this practice challenge. Scan again to retry.');
      return;
    }
    ...
    try {
      ...
      if (mounted) setState(() => _error = 'Could not load this practice challenge. Please try again.');
    } finally {
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_loading)
                    ...
                    Text(challenge.instructions, style: sketchBody(fontSize: 16.5)),
                    const SizedBox(height: 16),
                    ChallengeTags(challenge: challenge),
                  ],
                  const SizedBox(height: 40),
                  if (_error != null)
                    AtelierButton(label: 'retry', fill: AppColors.ink, onTap: _loadChallenge)
