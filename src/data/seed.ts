...
import type { ChallengeTemplate, LearningResource } from '../core/types/visual.js';

export const seedChallengeTemplates: ChallengeTemplate[] = defaultChallengeTemplates;
